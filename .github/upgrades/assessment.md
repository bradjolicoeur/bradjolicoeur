...
| 🔵 Behavioral change | 595 | Low - Behavioral changes that may require testing at runtime |
| ✅ Compatible | 12609 |  |
...
| :--- | :---: | :---: | :--- | :--- |
| FluentCache.Microsoft.Extensions.Caching.Memory | 4.0.0.2 |  | [bradjolicoeur.core.csproj](#bradjolicoeurcorebradjolicoeurcorecsproj)<br/>[bradjolicoeur.web.csproj](#bradjolicoeurwebbradjolicoeurwebcsproj) | ✅Compatible |
| LazyCache | 2.4.0 |  | [bradjolicoeur.core.csproj](#bradjolicoeurcorebradjolicoeurcorecsproj) | ✅Compatible |
| LazyCache.AspNetCore | 2.4.0 |  | [bradjolicoeur.web.csproj](#bradjolicoeurwebbradjolicoeurwebcsproj) | ✅Compatible |
| Markdig | 0.38.0 |  | [bradjolicoeur.web.csproj](#bradjolicoeurwebbradjolicoeurwebcsproj) | ✅Compatible |
...
| NSwag.ApiDescription.Client | 14.2.0 |  | [bradjolicoeur.core.csproj](#bradjolicoeurcorebradjolicoeurcorecsproj) | ✅Compatible |
| System.Reactive | 6.0.1 |  | [bradjolicoeur.core.csproj](#bradjolicoeurcorebradjolicoeurcorecsproj) | ✅Compatible |
...
| WebEssentials.AspNetCore.PWA | 1.0.85 |  | [bradjolicoeur.web.csproj](#bradjolicoeurwebbradjolicoeurwebcsproj) | ✅Compatible |
...
```mermaid
flowchart LR
    P1["<b>📦&nbsp;bradjolicoeur.web.csproj</b><br/><small>net9.0</small>"]
    P2["<b>📦&nbsp;bradjolicoeur.core.csproj</b><br/><small>net9.0</small>"]
    P1 --> P2
...
flowchart TB
    ...
    subgraph current["bradjolicoeur.core.csproj"]
        MAIN["<b>📦&nbsp;bradjolicoeur.core.csproj</b><br/><small>net9.0</small>"]
...
| 🟡 Source Incompatible | 1 | Medium - Needs re-compilation and potential conflicting API error fixing |
| 🔵 Behavioral change | 588 | Low - Behavioral changes that may require testing at runtime |
| ✅ Compatible | 7884 |  |
...
flowchart TB
    subgraph current["bradjolicoeur.web.csproj"]
        MAIN["<b>📦&nbsp;bradjolicoeur.web.csproj</b><br/><small>net9.0</small>"]
